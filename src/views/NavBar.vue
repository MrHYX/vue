<template>
    ...
    <!-- 导航菜单 -->
    <el-menu ref="navmenu" default-active="1" :class="collapse?'menu-bar-collapse-width':'menu-bar-width'" background-color="#303133" text-color="#fff" active-text-color="      #ffd04b"
